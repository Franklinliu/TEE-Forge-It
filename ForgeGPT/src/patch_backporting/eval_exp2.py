...
def run_eval_exp2(max_workers: int = None):
    ...
    output_path = vim_neovim_file_path.replace(".json", "_exp2_result.json")
    output_raw_path = vim_neovim_file_path.replace(".json", "_exp2_raw_result.json")
